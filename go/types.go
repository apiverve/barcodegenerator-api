// Package barcodegenerator provides a Go client for the Barcode Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/barcodegenerator?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Barcode Generator API.
//
// Parameters:
//   - data (required): string - The data you want to generate a barcode from (string)
//   - type (required): string - The type of barcode you want to generate
//   - lineColor: string - The color of the barcode (default: #000000)
//   - backgroundColor: string - The background color of the barcode (default: #ffffff)
//   - displayValue: boolean - Whether to display the value below the barcode (default: true)
type Request struct {
	Data string `json:"data"` // Required
	Type string `json:"type"` // Required
	LineColor string `json:"lineColor,omitempty"` // Optional
	BackgroundColor string `json:"backgroundColor,omitempty"` // Optional
	DisplayValue bool `json:"displayValue,omitempty"` // Optional
}
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		...
		"displayValue": {Type: "boolean", Required: false},
	}
...
// ResponseData contains the data returned by the Barcode Generator API.
