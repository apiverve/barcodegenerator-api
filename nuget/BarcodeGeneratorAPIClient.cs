...
namespace APIVerve.API.BarcodeGenerator
{
    ...
    /// <summary>
    /// Client for the BarcodeGenerator API
    /// </summary>
    public class BarcodeGeneratorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/barcodegenerator";
        ...
        {
            { "data", new ValidationRule { Type = "string", Required = true } },
            { "type", new ValidationRule { Type = "string", Required = true } },
            { "lineColor", new ValidationRule { Type = "string", Required = false } },
            { "backgroundColor", new ValidationRule { Type = "string", Required = false } },
            { "displayValue", new ValidationRule { Type = "boolean", Required = false } }
        };
        ...
        public BarcodeGeneratorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BarcodeGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public BarcodeGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, BarcodeGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(BarcodeGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(BarcodeGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(BarcodeGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(BarcodeGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(BarcodeGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(BarcodeGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(BarcodeGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(BarcodeGeneratorQueryOptions options)
        {
