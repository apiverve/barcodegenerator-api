...
class barcodegeneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/barcodegenerator');
        }
        ...
        this.validationRules = {"data":{"type":"string","required":true},"type":{"type":"string","required":true},"lineColor":{"type":"string","required":false},"backgroundColor":{"type":"string","required":false},"displayValue":{"type":"boolean","required":false}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/barcodegenerator`);
        }
    }
...
module.exports = barcodegeneratorWrapper;
