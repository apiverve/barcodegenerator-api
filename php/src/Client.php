...
namespace APIVerve\Barcodegenerator;
...
/**
 * Client for the Barcode Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/barcodegenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/barcodegenerator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\BarcodegeneratorClient] {$message}\n";
        }
    }
}
